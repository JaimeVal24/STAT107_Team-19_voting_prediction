...
2. BASELINE MODEL: STANDARD LOGISTIC REGRESSION
...
3. HYPOTHESIS MODEL: URBAN/CULTURE (Guns + Transit)
...
4. VARIABLE SELECTION: LASSO REGRESSION (Demographics Only)
...
5. CHAMPION MODEL: REFIT LASSO SURVIVORS
...
5.1 TESTING WITH DIFFERENT TEST SPLIT
...
6. COMPARISON: FORWARD SELECTION (P-Values < 0.05)
