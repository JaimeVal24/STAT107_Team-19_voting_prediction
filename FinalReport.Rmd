...
```
Lastly, we can create box plots to understand  the distribution of the datasets through their median, spread, and overall range. They highlight the central tendency, variability, and possible outliers and will give us more insight into our specific data and the validity of it as we are able to identify any skewed distributions. These speicifc ones are just a few of all of the box plots we can create for each varaible introduced. 
