...
#   pie(avg_race_dem, labels = race_data, main = paste("Democratic", year), cex = 0.6)
#    pie(avg_race_rep, labels = race_data, main = paste("Republican", year), cex = 0.6)
#}
```
...
#   
#  barplot(bar_vector, names.arg = c("Republican", "Democrat"), main = paste("Average", var, "by 2016 Voting"), ylab = var, cex.main = 0.8)
#}
# par(mfrow = c (1, 1))
```
