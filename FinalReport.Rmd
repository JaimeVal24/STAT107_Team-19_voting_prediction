...
i <- 1
comparison_names  <- c("Rate of Households that Own Guns (%)", "Age-Adjusted COVID Rate per 100000", "Unemployement Rate (%)", "Median Household Income (USD)")
